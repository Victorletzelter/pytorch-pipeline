...
# Credits : https://github.com/Victorletzelter/seld-net/blob/51efb7b6d8968a1eec231126de12c9c8e1833ab8/cls_feature_class.py
#
...
class FeatureClass:
    def __init__(self, dataset='ansim', ov=3, split=1, nfft=1024, db=30, wav_extra_name='', desc_extra_name=''):
        """The __init__ function is the constructor method for the FeatureClass class. It is responsible for initializing the class variables when an instance of the class is created.

        The function takes several parameters as input, including:

        dataset: a string that specifies the dataset to be used. The default value is 'ansim'.
        ov: an integer that specifies the overlap between frames when creating the spectrogram. The default value is 3.
        split: an integer that specifies the number of frames in 1 second. The default value is 1.
        nfft: an integer that specifies the number of FFT points to use when creating the spectrogram. The default value is 1024.
        db: an integer that specifies the decibel level to use when creating the spectrogram. The default value is 30.
        wav_extra_name: a string that specifies an additional name to be added to the audio files. The default value is an empty string.
        desc_extra_name: a string that specifies an additional name to be added to the description files. The default value is an empty string.
        """
    ...
    def _load_audio(self, audio_path):
        """
        This function takes in the path to an audio file and loads it, returning the audio data as a numpy array.
        """
    ...
    def _spectrogram(self, audio_input):
        """
        This function takes in audio data as a numpy array and returns the spectrogram of the audio data, a 2D array of the short-time Fourier 
        transform of the audio data.
        """
    ...
    def _extract_spectrogram_for_file(self, audio_filename):
        """
        This function takes in the name of an audio file, loads the audio file, extracts the spectrogram of the audio data, and saves the spectrogram data to disk in a specified directory.
        """
    ...
    def _read_desc_file(self, desc_filename):
        """
        This function reads the description file (in .txt format) for a given audio file, and extracts information such as the azimuth, elevation, and class label for each frame in the audio file.
        """
        desc_file = {
    ...
    def get_list_index(self, azi, ele):
        """
        Given an azimuth and elevation, this function returns the corresponding index in the list of unique azimuth and elevation values.
        """
    ...
    def _get_matrix_index(self, ind):
        """
        Given a linear index, this function returns the corresponding row and column indices in the matrix of azimuth and elevation values."""
    ...
    def get_vector_index(self, ind):
        """
        Given a linear index, this function returns the corresponding index in the vector of unique azimuth and elevation values.
        """
    ...
    def scaled_cross_product(a, b):
        """
        This function calculates the cross product of two vectors and scales it by the sine of the angle between them.
        """
        ab = np.dot(a, b)
        if ab > 1 or ab < -1:
            return [999]
    ...
    def get_trajectory(self, event_length_s, _start_xyz, _rot_vec, _random_ang_vel):
        """
        This function generates a trajectory of azimuth and elevation values over time, given an initial starting point, a rotation vector, and a random angular velocity.
        """
    ...
    def rotate_matrix_vec_ang(_rot_vec, theta):
        """
        This function rotates a matrix by an angle theta about an axis specified by a rotation vector.
        """
        u_x_u = np.array(
            [
    ...
    def cart2sph(x, y, z):
        """
        this function is used to convert cartesian coordinates (x, y, z) to spherical coordinates (azimuth, elevation and radius)
        """
        XsqPlusYsq = x ** 2 + y ** 2
    ...
    def wrapToPi(rad_list):
        """
        this function wraps the input list of radian values to the range of [-π, π]
        """
    ...
    def wrapTo180(self, deg_list):
        """
         this function wraps the input list of degree values to the range of [-180, 180]"""
    ...
    def _get_doa_labels_regr(self, _desc_file):
        """
        This function is used to extract the DOA (Direction of Arrival) labels for the given audio file, in the regression mode."""
    ...
    def _get_se_labels(self, _desc_file):
        """
        This function is used to extract the SE (Sound Event) labels for the given audio file.
        """
    ...
    def _get_labels_for_file(self, label_filename, _desc_file):
        """
        This function is used to extract the labels for the given audio file, depending on the mode that was set.
        """
        label_mat = None
    ...
    def extract_all_feature(self, extra=''):
        """
        This function is used to extract the features (spectrogram) for all the audio files in the dataset.
        """
        # setting up folders
    ...
    def preprocess_features(self, extra=''):
        """
        This function is used to preprocess the extracted features by normalizing the data and splitting it into training and validation
         """
    ...
    def normalize_features(self, extraname=''):
        """
        This function is used to normalize the extracted features by subtracting the mean and dividing by the standard deviation.
        """
        # Setting up folders and filenames
    ...
    def extract_all_labels(self, mode='regr', weakness=0, extra=''):
        """
        This function extract the labels for the audio files. It takes in 3 optional parameters mode, 
        weakness and extra. mode is the type of label extraction, weakness is the level of weakness 
        used for label extraction and extra is an additional string that can be added to the output file name. 
        It creates the label_dir and then for each file in the description directory, it calls the _get_labels_for_file function 
        to get the labels for that file.
        """
    ...
    def get_normalized_feat_dir(self, extra=''):
        """
        This function returns the directory path for the normalized features. 
        It takes in an optional parameter extra which is an additional string 
        that can be added to the output file name."""
        return os.path.join(
            self._base_folder,
    ...
    def get_unnormalized_feat_dir(self, extra=''):
        """
        This function returns the directory path for the unnormalized features. 
        It takes in an optional parameter extra which is an additional string that can be added to the output file name.
        """
        return os.path.join(
            self._base_folder,
    ...
    def get_label_dir(self, mode, weakness, extra=''):
        """
        This function returns the directory path for the labels. 
        It takes in 2 required parameters mode and weakness and an optional parameter extra which is 
        an additional string that can be added to the output file name.
        """
        return os.path.join(
            self._base_folder,
    ...
    def get_normalized_wts_file(self, extra=''):
        """
        This function returns the file path for the normalized weights. 
        It takes in an optional parameter extra which is an additional string that can be added to the output file name."""
        return os.path.join(
            self._base_folder,
    ...
    def get_default_azi_ele_regr(self):
        """
        This function returns the default azimuth and elevation used in the label extraction when mode is 'regr'
        """
        return self._default_azi, self._default_ele

    def get_nb_channels(self):
        """
        This function returns the number of channels used in the audio files."""
        return self._nb_channels

    def nb_frames_1s(self):
        """
        This function returns the number of frames in one second of audio."""
